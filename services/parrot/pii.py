...
class Pseudonymizer:
    ...
    def redact_message(self, text: str) -> str:
        ...
        lookup = dict(order)
        return self._redact(text, self._all_re, lambda v: lookup.get(v, v))
    ...
    def redact_data(self, text: str) -> str:
        ...
        lookup = {self.surname.lower(): SURNAME, self.name.lower(): NAME}
        return self._redact(text, self._names_re, lambda v: lookup.get(v, v))
