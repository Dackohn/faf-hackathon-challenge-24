...
func LoadConfig() Config {
	...
	submarine := splitEnv("SUBMARINE_SERVICE_URL", "")
	...
	return Config{
		...
		SubmarineServiceURL: firstURL(submarine),
		...
		SubmarineServicePool: submarine,
